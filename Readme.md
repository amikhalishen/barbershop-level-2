# Лекционный проект «Барбершоп Бородинский» [![Build status][travis-image]][travis-url] [![Dependency status][dependency-image]][dependency-url]
## HTML Academy. Профессиональный HTML и CSS уровень 2

* Студент: [Дмитрий Разиньков](#).
* Наставник: `Лектор HTML Academy`.
